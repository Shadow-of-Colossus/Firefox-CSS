  ...
  init: function () {
    ...
    CustomizableUI.createWidget({
      ...
      onBuild: function (aDocument) {
        ...
        const viewCache = aDocument.getElementById('appMenu-viewCache').content;
        ...
        if (viewCache) {          
          ...
          const addonsButton = aDocument.getElementById('appMenu-addons-button') ?? viewCache.getElementById('appMenu-addons-button');
